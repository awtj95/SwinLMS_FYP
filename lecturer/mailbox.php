        ...
        <!-- Content Header (Page header) -->
            ...
            <!-- Main row -->
                ...
                <!-- Left col -->
                    ...
                    ?>
                                    <tr>
                                        <td class="left" width="30"><a href="#"><?php echo htmlentities($dn1['subject'], ENT_QUOTES, 'UTF-8'); ?></a></td>
                    ...
                    ?>
                                    <tr>
                                        <td class="left" width="20"><a href="#"><?php echo htmlentities($dn2['subject'], ENT_QUOTES, 'UTF-8'); ?></a></td>
                                        ...
                                        <td width="20"><a href="#" class="delete-button"><i class="fa fa-trash-o"></i></a></td>
                                    </tr>
                    <?php
                        }
