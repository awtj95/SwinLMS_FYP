                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <i class="fa fa-book"></i>
                                    <h3 class="box-title">Lecture Note List</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <ul class="courselist">
                                    ...
                                    <li>
                                        ...
                                        <a href="lecture/remove.php?id=<?php echo $course['id'] ?>&unit_id=<?php echo $_SESSION['unit_id']; ?>&name=<?php echo $_GET['name']; ?>" class="delete-button"><i class="fa fa-trash-o"></i></a>
