...
$sql = "select id from users where type='parent' ";
...
<html>
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<input type="hidden" class="form-control" id="ty" value="parent">
				  </div>
				  <div class="form-group">
   ...
   <script>
    function saveData(){
    	...
    	$.ajax({
    		type: "POST",
    		url: "../admin/server/parent.php?p=add",
	...
	function linkData(){
		...
		$.ajax({
			type: "POST",
			url: "../admin/server/parent.php?p=link",
			data: "u1="+user_id1+"&u2="+user_id2,
			success: function(data){
				viewData();
			}
		});
    ...
    function updateData(str){
		...
		$.ajax({
    		type: "POST",
    		url: "../admin/server/parent.php?p=edit",
    ...
    function deleteData(str){
    	...
    	$.ajax({
    		type: "GET",
    		url: "../admin/server/parent.php?p=del",
    		data: "id="+id,
    		success: function(data){
    			viewData();
    		}
