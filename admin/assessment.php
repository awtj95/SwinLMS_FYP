				  ...
				  <div class="box box-primary">
                    <div class="box-header">
                      ...
                      <form action="upload.php" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<input type="submit" name="assessment-upload" value="Upload" class="btn btn-info"/>
							</div>
					 ...
					 <legend>Assessment Form</legend>
						<table class="table table-striped table-hover">
							...
							<tr>
								...
								<td><a href="upload/uploads/assessment/<?php echo $row['filename']; ?>" download>Download</td>                    
								<td>          
									<a href="form/removeass.php?id=<?php echo $row['id']; ?>">Delete</a>
								</td>
							</tr>
							<?php } ?>
							</tbody>
