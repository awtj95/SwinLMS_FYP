...
// fetch files
$sql = "select id,filename from graduation";
				  ...
				  <div class="box box-primary">
                    <div class="box-header">
                      ...
                      <form action="upload.php" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<input type="submit" name="graduation-upload" value="Upload" class="btn btn-info"/>
							</div>
					 ...
					 <legend>Graduation Form</legend>
						<table class="table table-striped table-hover">
							...
							<tr>
								...
								<td><a href="upload/uploads/graduation/<?php echo $row['filename']; ?>" download>Download</td>                    
								<td>          
									<a href="form/remove.php?id=<?php echo $row['id']; ?>">Delete</a>
								</td>
							</tr>
							<?php } ?>
							</tbody>
