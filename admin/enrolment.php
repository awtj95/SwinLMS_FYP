...
// fetch files
$sql = "select id,filename from enrolment";
				  ...
				  <div class="box box-primary">
                    <div class="box-header">
                      ...
                      <form action="upload.php" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<input type="submit" name="enrolment-upload" value="Upload" class="btn btn-info"/>
							</div>
					 ...
					 <legend>Enrolment Form</legend>
						<table class="table table-striped table-hover">
							...
							<tr>
								...
								<td><a href="upload/uploads/enrolment/<?php echo $row['filename']; ?>" download>Download</td>                    
								<td>          
									<a href="form/removeenrol.php?id=<?php echo $row['id']; ?>">Delete</a>
								</td>
							</tr>
							<?php } ?>
							</tbody>
